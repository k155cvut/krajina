...
__Český úřad zeměměřický a katastrální__ (ČÚZK) je státní instituce spravující katastr nemovitostí. Pod tento orgán spadá __Zeměměřický úřad__, který má na starosti mj. správu státního mapového díla (oficiální mapy ČR) a __poskytování geodetických a kartografických dat__. V rámci této služby úřad poskytuje i webovou mapovou prohlížečku – tzv. __Geoprohlížeč__ dostupný na __[této adrese](https://ags.cuzk.cz/geoprohlizec/){.underlined .external_link_icon}__.
